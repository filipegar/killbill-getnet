...
public class GetnetPaymentMethodPlugin extends PluginPaymentMethodPlugin {

	public GetnetPaymentMethodPlugin(UUID kbPaymentMethodId, String externalPaymentMethodId,
